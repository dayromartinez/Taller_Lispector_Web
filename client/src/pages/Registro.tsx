  ...
  return (
    <div className='bg-gray-100'>
        ...
        <div className="flex w-full mx-auto">
            <img className='w-full h-full' src={clarice}/>
            <form className="bg-white shadow-md max-w-md mx-auto rounded px-8 pt-6 pb-8">
                <h5 className='text-2xl my-3 mb-5 font-bold mt-44'>Registrarse</h5>
