      ...
      <footer className="text-center w-full" style={{'color': '#4D4D4D', marginTop: 450,}}>
        ...
        <div className="text-center p-4 pb-1" style={{ backgroundColor: '#9FD5D1', height: '220px', margin: 0, padding: 0 }}>
          ...
          <div className="w-full">
            ...
            © {year} Copyright:
            <Link className="text-whitehite md:hover:font-bold hover:underline underline-offset-4 hover:decoration-emerald-300" to="/"> Taller Lispector.</Link>
            <br />
            Diseño por 
            <a href="https://www.instagram.com/manuel_mateus525/" target="_blank" className="text-whitehite md:hover:font-bold hover:underline underline-offset-4 hover:decoration-emerald-300"> Manuel Mateus. </a>
            Desarrollo por
            <a href="https://www.instagram.com/dayro_martinez/" target="_blank" className="text-whitehite md:hover:font-bold hover:underline underline-offset-4 hover:decoration-emerald-300"> Dayro Martínez </a>
            y 
