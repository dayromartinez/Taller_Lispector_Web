...
import { colors, settings } from './NavbarDesktopAdmin';
...
export default function NavbarMobileAdmin({ children }) {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
          {['Inicio', 'Sesiones', 'Publicaciones', 'Crear Sesión', 'Crear Publicación'].map((text, index) => (
